...
//	
//
//  Source file: /home/zach/Documents/Stanford/classes/ee272/ee272_cgra/pe_core/genesis/test_pe.svp
...
logic res_lut; //Not sure what to do about LUT result (make it 4 bit?)
    ...
    always_comb begin
        case (flag_sel)
            ...
            PE_FLAG_GE  : result_flag = {(N == V), {3{1'b0}}};
            PE_FLAG_LT  : result_flag = {(N != V), {3{1'b0}}};
            PE_FLAG_GT  : result_flag = {((~(|Z)) & (N == V)),{3{1'b0}}};
            PE_FLAG_LE  : result_flag = {((|Z) | (N != V)),{3{1'b0}}};
...
test_debug_reg #(.DataWidth(4)) test_debug_bit
(
  .cfg_clk   (clk),
  .cfg_rst_n (rst_n),
  .cfg_d     (cfg_d[3:0]),
