...
test_pe(clk: In(Clock), rst_n: In(AsyncReset), clk_en: In(Bit), cfg_d: In(Bits(32)), cfg_a: In(Bits(8)), cfg_en: In(Bit), data0: In(Bits(16)), data1: In(Bits(16)), bit0: In(Bit), bit1: In(Bit), bit2: In(Bit), res: Out(Bits(16)), irq: Out(Bit), res_p: Out(Bits(4)), read_data: Out(Bits(32)))
"""  # nopep8
