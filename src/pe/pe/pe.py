    ...
    def get_flag(self, ra, rb, rc, rd, alu_res, alu_res_p, lut_out):
        ...
        if self._opcode == 0x0: # add
            ...
            V = ((ra[0:8]*rb[0:8])[7] if (ra[7] == rb[7]) else (ra[0:8]*rb[0:8])[7] == 0 and (ra[0:8]!=0 or rb[0:8]!=0)) or \
                ((ra[8:16]*rb[8:16])[7] if (ra[16] == rb[16]) else (ra[8:16]*rb[8:16])[15] == 0 and (ra[8:16]!=0 or rb[8:16]!=0))
            ...
            V = ((ra[3] == rb[3]) and (ra[3] != (ra[0:4] + rb[0:4])[3])) or \
                ((ra[7] == rb[7]) and (ra[7] != (ra[4:8] + rb[4:8])[3])) or \
